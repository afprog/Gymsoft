 ...
 * AsociacionMaquinaUsuario entities. Transaction control of the save(),
 ...
 * 
 * @see co.edu.uniminuto.arqsoft.daos.AsociacionMaquinaUsuario
 * @author MyEclipse Persistence Tools
 */
public class AsociacionMaquinaUsuarioDAO implements
		IAsociacionMaquinaUsuarioDAO {
	// property constants
	 ...
	 * AsociacionMaquinaUsuarioDAO.save(entity);
	...
	public void save(AsociacionMaquinaUsuario entity) {
		EntityManagerHelper.log("saving AsociacionMaquinaUsuario instance",
				Level.INFO, null);
		try {
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * AsociacionMaquinaUsuarioDAO.delete(entity);
	 * EntityManagerHelper.commit();
	 * entity = null;
	 * </pre>
	 * 
	...
	public void delete(AsociacionMaquinaUsuario entity) {
		EntityManagerHelper.log("deleting AsociacionMaquinaUsuario instance",
				Level.INFO, null);
		try {
			entity = getEntityManager().getReference(
					AsociacionMaquinaUsuario.class,
					entity.getAsociacionMauinaUsuarioId());
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = AsociacionMaquinaUsuarioDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	...
	public AsociacionMaquinaUsuario update(AsociacionMaquinaUsuario entity) {
		EntityManagerHelper.log("updating AsociacionMaquinaUsuario instance",
				Level.INFO, null);
		try {
			AsociacionMaquinaUsuario result = getEntityManager().merge(entity);
	...
	public AsociacionMaquinaUsuario findById(Integer id) {
		EntityManagerHelper.log(
				"finding AsociacionMaquinaUsuario instance with id: " + id,
				Level.INFO, null);
		try {
			AsociacionMaquinaUsuario instance = getEntityManager().find(
					AsociacionMaquinaUsuario.class, id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<AsociacionMaquinaUsuario> findByProperty(String propertyName,
		...
		EntityManagerHelper.log(
				"finding AsociacionMaquinaUsuario instance with property: "
						+ propertyName + ", value: " + value, Level.INFO, null);
		try {
			final String queryString = "select model from AsociacionMaquinaUsuario model where model."
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<AsociacionMaquinaUsuario> findAll(
			final int... rowStartIdxAndCount) {
		EntityManagerHelper.log(
				"finding all AsociacionMaquinaUsuario instances", Level.INFO,
				null);
		try {
			final String queryString = "select model from AsociacionMaquinaUsuario model";
			Query query = getEntityManager().createQuery(queryString);
			if (rowStartIdxAndCount != null && rowStartIdxAndCount.length > 0) {
				int rowStartIdx = Math.max(0, rowStartIdxAndCount[0]);
				if (rowStartIdx > 0) {
