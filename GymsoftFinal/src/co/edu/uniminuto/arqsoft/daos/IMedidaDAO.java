...
public interface IMedidaDAO {
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = IMedidaDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	 ...
	 */
	public List<Medida> findByProperty(String propertyName, Object value,
	 ...
	 */
	public List<Medida> findAll(int... rowStartIdxAndCount);
}