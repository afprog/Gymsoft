 ...
 * datastore.
 * 
 * @see co.edu.uniminuto.arqsoft.daos.Usuario
...
public class UsuarioDAO implements IUsuarioDAO {
	...
	public List<Usuario> findByApellidos(Object apellidos,
			int... rowStartIdxAndCount) {
		return findByProperty(APELLIDOS, apellidos, rowStartIdxAndCount);
	}

	public List<Usuario> findByGenero(Object genero, int... rowStartIdxAndCount) {
		return findByProperty(GENERO, genero, rowStartIdxAndCount);
	}
