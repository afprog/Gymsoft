...
/***************************************************
 * DAO class of usuario table. Generated on Thu Sep 12 21:23:18 COT 2013
 ***************************************************/

public class UsuarioDAOImpl extends CustomDAOSupport<Usuario, Long> implements
		Serializable, UsuarioDAO {
	...
	/**
	 * @return Usuario Generated on: Thu Sep 12 21:23:18 COT 2013
	 * @See Usuario
	 */
	 ...
	 * Inserts Usuario
	 * 
	 * @param: Usuario Generated on: Thu Sep 12 21:23:18 COT 2013
	 * @See Usuario
	 */
	...
	public List<Usuario> getUsuarioByIdusuario(Integer idusuario) {
		...
		Query query = getDAOManager().createQuery(
				" select t from Usuario t where t.idusuario = ?1 ");
	 ...
	 * @param: int maxresults Generated on: Thu Sep 12 21:23:18 COT 2013
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByIdusuario(Integer idusuario,
	...
	/**
	 * @return Usuario
	 * @param: java.lang.String Nombre Generated on: Thu Sep 12 21:23:18 COT
	 *         2013
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByNombre(String nombre) {
		...
		Query query = getDAOManager().createQuery(
				" select t from Usuario t where t.nombre = ?1 ");
	 ...
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByNombre(String nombre, int startPosition,
			int maxResult) {
	...
	/**
	 * @return Usuario
	 * @param: java.lang.String Genero Generated on: Thu Sep 12 21:23:18 COT
	 *         2013
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByGenero(String genero) {
		...
		Query query = getDAOManager().createQuery(
				" select t from Usuario t where t.genero = ?1 ");
	 ...
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByGenero(String genero, int startPosition,
			int maxResult) {
	...
	/**
	 * @return Usuario
	 * @param: java.util.Date Fechanacimiento Generated on: Thu Sep 12 21:23:18
	 *         COT 2013
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByFechanacimiento(Date fechanacimiento) {
		...
		Query query = getDAOManager().createQuery(
				" select t from Usuario t where t.fechanacimiento = ?1 ");
	...
	/**
	 * @return Usuario
	 * @param: java.lang.Integer Altura Generated on: Thu Sep 12 21:23:18 COT
	 *         2013
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByAltura(Integer altura) {
		...
		Query query = getDAOManager().createQuery(
				" select t from Usuario t where t.altura = ?1 ");
	 ...
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByAltura(Integer altura, int startPosition,
			int maxResult) {
	...
	/**
	 * @return Usuario
	 * @param: java.lang.Integer ActividadIdactividad Generated on: Thu Sep 12
	 *         21:23:18 COT 2013
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByActividadIdactividad(
			Integer actividadIdactividad) {

		Query query = getDAOManager().createQuery(
				" select t from Usuario t where t.actividadIdactividad = ?1 ");
	 ...
	 */
	public List<Usuario> getUsuarioByActividadIdactividad(
			Integer actividadIdactividad, int startPosition, int maxResult) {
	...
	/**
	 * @return Usuario
	 * @param: java.lang.String Perfil Generated on: Thu Sep 12 21:23:18 COT
	 *         2013
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByPerfil(String perfil) {
		...
		Query query = getDAOManager().createQuery(
				" select t from Usuario t where t.perfil = ?1 ");
	 ...
	 * @See Usuario
	 */
	public List<Usuario> getUsuarioByPerfil(String perfil, int startPosition,
			int maxResult) {
	...
	/**
	 * trae todos los usuarios que se buscan por identificacion
	 * 
